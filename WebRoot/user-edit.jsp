...
<body>
	<div class="layui-fluid">
		<div class="layui-row">
			<form class="layui-form" id="frmEdit" method="post"
				action="UserEditServlet" role="form">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" name="email" autocomplete="off"
							class="layui-input" value="${modifyUser.email}">
					</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" name="username" autocomplete="off"
							class="layui-input" value="${modifyUser.username}">
					</div>
				</div>
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="password" name="password" autocomplete="off"
							class="layui-input" value="${modifyUser.password}">
					</div>
				</div>
				<div class="layui-form-item">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" name="phone" autocomplete="off"
							class="layui-input" value="${modifyUser.phone_number}">
					</div>
					<div class="layui-form-mid layui-word-aux">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<select class="form-control" name="role" id="role">
							...
							<option value="管理员" ${modifyUser.role == '管理员' ? 'selected' : ''}>管理员</option>
							<option value="普通用户"
								${modifyUser.role == '普通用户' ? 'selected' : ''}>普通用户</option>
						</select>
					</div>
				</div>
				<div class="layui-form-item">
					...
					<button class="layui-btn" type="submit"
						onclick="return editUser(this.form)">修改</button>
				</div>
			</form>
		</div>
	</div>
